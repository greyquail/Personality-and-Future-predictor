...
# -----------------------------------------------------------------------------
# We are using "distilgpt2" as it is lightweight and runs on CPU.
...
# -----------------------------------------------------------------------------
# 3) Session Setup and Streamlit UI
# -----------------------------------------------------------------------------
...
st.write("""
This app is self-hosted using the Transformers library (distilgpt2) and does not rely on external API tokens.
Enter a past decision and describe your current mindset to see your possible futures.
""")
...
st.write("© 2025 Unlimited Future Predictor. For educational purposes only.")

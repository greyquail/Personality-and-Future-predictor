...
# -----------------------------------------------------------------------------
# Ensure you have set your API key in the Streamlit Cloud Secrets as described.
...
def generate_explanation(choice, future, user_history):
    """
    Calls OpenAI's GPT to generate a detailed explanation for why this future might occur,
...
def predict_multiverse(choice, mindset_score):
    ...
    and sentiment (mindset_score). This simulates different timeline outcomes.
    """
    base_futures = [

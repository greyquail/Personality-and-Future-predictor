...
# --------------------------------------------------------------
# Load AI Model (Nous-Hermes-2 Mistral 7B - Public Model)
# --------------------------------------------------------------
@st.cache_resource(show_spinner=True)
def load_model():
    """Load a fully public AI model that works on Streamlit."""
    model_name = "TheBloke/Nous-Hermes-2-Mistral-7B-GGUF"  # Public model
...
if st.button("Predict Future"):
    if user_input:
        ...
        st.warning("Please enter your personality traits or situation.")p
